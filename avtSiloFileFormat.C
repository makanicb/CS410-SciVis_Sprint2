...
//
//    Makani Buckley, Mon June 8 13:58:10 PDT 2022
//    Handle NULL material names in Silo database, just use material number
//    for name.
// ****************************************************************************
    ...
    int dom)
{
    ...
    if (haveMatnames)
    {
            ...
            if(matname)
	    {
            ...
            else // In case of NULL material name, just use material number
	    {
                sprintf(matnames[i], "%d", matno);
	    }
        }
    }
