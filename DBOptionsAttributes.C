...
//
//  Modifications:
//    Makani Buckley, Sat May 30 17:39:20 PDT 2026
//    I changed the behavior to warn and create a new enumerated type instead
//    of crashing when no matching enumerated type is found.
// ****************************************************************************
                                    ...
                                    const std::vector<std::string> &values)
{
    ...
    if (eIndex < 0)
        cerr << "WARNING: No enumerated type " << name <<
            " found. Creating a new enumerated type with default value 0"
            << endl;
        SetEnum(name, 0);
        //EXCEPTION0(BadDeclareFormatString);
