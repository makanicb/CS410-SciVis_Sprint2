...
{
    cerr << "ViewerPlot::SetBackgroundColor" << endl;
    cerr << "\tInitial Color: (" << (int) (bgColor[0]*255) << ", " 
	    << (int) (bgColor[1]*255) << ", " 
	    << (int) (bgColor[2]*255) << ")" << endl;
    bool retval = false;
    bgColor[0]  = bg[0];
    bgColor[1]  = bg[1];
    bgColor[2]  = bg[2];
    ...
    cerr << "\tFinal Color: (" << (int) (bgColor[0]*255) << ", " 
	    << (int) (bgColor[1]*255) << ", " 
	    << (int) (bgColor[2]*255) << ")" << endl;
...
{
    cerr << "ViewerPlot::SetForegroundColor" << endl;
    cerr << "\tInitial Color: (" << (int) (fgColor[0]*255) << ", " 
	    << (int) (fgColor[1]*255) << ", " 
	    << (int) (fgColor[2]*255) << ")" << endl;
    bool retval = false;
    fgColor[0]  = fg[0];
    fgColor[1]  = fg[1];
    fgColor[2]  = fg[2];
    ...
    cerr << "\tFinal Color: (" << (int) (fgColor[0]*255) << ", " 
	    << (int) (fgColor[1]*255) << ", " 
	    << (int) (fgColor[2]*255) << ")" << endl;
